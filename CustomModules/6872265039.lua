...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/nebulawaree/NebulaForRoblox/main/"..scripturl, true)
	end
end
...
local function getcustomassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/nebulawaree/NebulaForRoblox/main/"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
...
runcode(function()
	...
	GetHash = GuiLibrary.ObjectsThatCanBeSaved.UtilityWindow.Api.CreateOptionsButton({
		Name = 'GetHash',
	...
	task.spawn(function()
		pcall(function()
			if not isfile("vape/Profiles/bedwarsdata.txt") then
				local commit = "main"
				for i,v in pairs(game:HttpGet("https://github.com/nebulawaree/NebulaForRoblox"):split("\n")) do
				...
				writefile("vape/Profiles/bedwarsdata.txt", game:HttpGet("https://raw.githubusercontent.com/nebulawaree/NebulaForRoblox/"..commit.."/CustomModules/bedwarsdata", true))
			end
			...
			repeat
				...
				local newdata = game:HttpGet("https://raw.githubusercontent.com/nebulawaree/NebulaForRoblox/"..commit.."/CustomModules/bedwarsdata", true)
